    ...
    <div className="p-8 md:p-12 space-y-8 text-sm leading-relaxed">
      ...
      <section>
        ...
        <p>
          ...
          서비스입니다. 플랫폼은 법률 판단을 하거나 강제집행을 직접 수행하지
          않습니다.
        </p>
      </section>
      ...
      <section>
        ...
        <p>
          ...
          불과하며 플랫폼이 수임을 강제하지 않습니다. 개별 사건에 대한 계약은
          이용자와 해당 전문가 간에 직접 체결됩니다.
        </p>
      </section>
      ...
      <section>
        ...
        <p>
          회원 탈퇴 시 계정은 즉시 비활성화됩니다. 다만, 서비스 이용 과정에서
          생성된 사건 정보는 AI 모델 학습 및 통계 분석을 위해 익명화 또는
          가명화하여 계속 활용될 수 있습니다.
        </p>
      </section>
      ...
      <section>
        <h2 className="text-lg font-bold text-slate-900 mb-2">
          제10조 (콘텐츠 저작권 및 기술 고지)
        </h2>
        <p>1. 모든 콘텐츠의 저작권은 플랫폼에 귀속됩니다.</p>
        <p>
          2. 본 서비스 내 사용된 일부 이미지 및 디자인 리소스는 생성형
          AI(Generative AI) 기술을 활용하여 제작되었습니다. 이는 특정 인물의
          초상권을 침해하지 않도록 생성되었습니다.
        </p>
      </section>
...
export default function TermsPage() {
  return (
    <div className="min-h-screen bg-slate-50 py-12 px-6 text-slate-700">
