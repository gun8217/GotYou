  ...
  return (
    <div className={styles.AboutPage}>
      <Flex direction="column" gap={40} className="contentsPage">
        ...
        <Flex wrap="wrap" gap={20}>
          <Card title="판결은 받았지만, 돈은 받지 못했습니다.">
            <Flex direction="column" gap={8}>
              ...
              <Text size="sm" color="secondary" as="p">
                ...
                알려주지 않았습니다.
                <br />
                어디서부터 무엇을 해야 하는지, 얼마가 들고 얼마나 걸리는지조차
                알기 어려웠습니다.
              </Text>
            </Flex>
          </Card>

          <Card title="문제는 판결 이후" className={styles.widthHalf}>
            <Flex direction="column" gap={8}>
              <Text size="sm" color="secondary" as="p">
              ...
              <Text as="p">
                승소에 들어간 많은 시간과 비용이 의미 없이 사라지는 것을
                방치하면 안됩니다.
              </Text>
            </Flex>
          </Card>
          ...
          >
            <Flex direction="column" gap={8}>
              ...
              <Text as="p">
                승소 이후의 과정을 정리하고, 누구나 이해할 수 있게 설명하는
                서비스
              </Text>
            </Flex>
          </Card>
        ...
        <Flex direction="column" align="center" gap={10}>
          <Title level={1}>승소는 끝이 아니라, 시작입니다.</Title>
          <Text color="secondary" as="p">
            판결을 종이에서 현실로 바꾸는 길, 집행나침반가 함께합니다.
          </Text>
        </Flex>
      </Flex>
    </div>
