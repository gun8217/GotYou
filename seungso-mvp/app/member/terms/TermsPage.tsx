...
export default function TermsPage({
  ...
  return (
    <div className={styles.terms}>
      ...
      <section>
        <Title level={2}>제2조 (서비스의 성격)</Title>
        <Text>
      ...
      <section>
        <Title level={2}>제4조 (이용자의 책임)</Title>
        <Text>
      ...
      <section>
        <Title level={2}>제5조 (외부 전문가와의 관계)</Title>
        <Text>
      ...
      <section>
        <Title level={2}>제6조 (성공 여부의 정의)</Title>
        <Text>
      ...
      <section>
        <Title level={2}>제7조 (회원 탈퇴 및 데이터 활용)</Title>
        <Text>
      ...
      <section>
        <Title level={2}>제9조 (서비스 이용 제한)</Title>
        <Text>
      ...
      <section>
        <Title level={2}>제10조 (콘텐츠 저작권 및 기술 고지)</Title>
        <Text>
